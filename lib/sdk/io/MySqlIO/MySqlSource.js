...
class MySqlReader {
  ...
  start() {
    ...
    const configuration = source.spec.configuration
    ...
    const statement = this.connection.prepareStatement(query, nestTables)
    this.stream = statement.executeQuery()
...
exports.MySqlReader = MySqlReader;

...
class DataSourceConfiguration extends Serializable {
  ...
  get username() {
    return hidden.get(this).get('username')
  }

  get password() {
    return hidden.get(this).get('password')
  }

  get connectionProperties() {
    return hidden.get(this).get('connectionProperties')
  }

  get dataSource() {
    return hidden.get(this).get('dataSource')
  }

...
console.log('gRPC Harness: Launching Docker container for beamish-grpc-harness');
...
docker.run(
  ...
  (err, data, container) => {
    console.log('gRPC Harness: Docker callback for beamish-grpc-harness:');
...
.on('container', () => {
  console.log('gRPC Harness: Docker container for beamish-grpc-harness launched');
})
;

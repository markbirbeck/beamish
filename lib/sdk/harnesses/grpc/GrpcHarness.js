  ...
  control(call) {
    ...
    call.on('data', request => {
      ...
      if (request.request === 'register') {
        ...
        console.log(`SDK Fn Harness: Creating direct harness #${id}`);

        let harness = this.harnesses[id] = new DirectHarness();

        console.log(`SDK Fn Harness: Registering graph in direct harness #${id}`);
      ...
      if (request.request === 'process_bundle') {
        ...
        console.log(`SDK Fn Harness: Retrieving direct harness #${id}`);
